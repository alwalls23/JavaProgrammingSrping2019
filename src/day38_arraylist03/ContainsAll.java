...
public class ContainsAll {
	public static void main(String[] args) {
		...
		nums2.add(10); nums2.add(20); nums2.add(30); nums2.add(40);
//		nums2.add(50);
		
		//test if nums1 has all nums2 values
		if(nums1.containsAll(nums2)) {
			System.out.println("Nums1 contains all of nums2");			
		}else {
			System.out.println("Nums1 does not contain all of nums2");
		}
