...
public class EtsyDotCom {
	public static void main(String[] args) {
		...
		EtsyAccount acct3 = new EtsyAccount("helireva@royalhost.ing", "Helireva", "royal1234");
		System.out.println(acct3.toString());

		EtsyAccount acct4 = new EtsyAccount("woodenspoon@gmail.com", "WdPoon");
		System.out.println(acct4.toString());

		final String password = "475dbg";
