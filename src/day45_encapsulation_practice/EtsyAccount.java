...
public class EtsyAccount {
	/*
	 * encapsulated email firstName password
	 * 
	...
	public EtsyAccount(String email, String firstName, String password) {
		this.setEmail(email);// you can also use this. method
	...
	private String getRandomPassword() {
		...
		String letters = "abcdefghijklmnopqrstuvwxyz01234556789";
		String rdPassword = "";
		for (int i = 0; i < 6; i++) {
	...
	private boolean isValidFirstName(String firstName) {
		// check first if it strts with or ends with space
